...
export NODE_READY_POLL_INTERVAL=${NODE_READY_POLL_INTERVAL:=5}
...
export DRAIN_TIMEOUT=${DRAIN_TIMEOUT:="120"}   # Seconds to wait for the node to drain before giving up
